...
The \textbf{model.py} file enables us to dynamically instantiate different models that are used for our analysis by mapping the model names stored on the \textbf{'models'} dictionary to the corresponding architectures. 
