...
% While all three models produce a ``mostly'' correct result, the IoU score in the baseline model is penalised by the patchiness of ts predictions as seen in \cref{baseline_vs_swin2}.
