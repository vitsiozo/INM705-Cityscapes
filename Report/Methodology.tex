...
In our experiments the second enhanced model (Swin2-JNet) is considerably stronger and less likely to have false positives, so we will train it ignoring these background pixels to later compare it to the other models.
