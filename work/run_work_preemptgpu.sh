...
python work.py --num-epochs 50 --optimiser Adam --lr 0.001                                                                                                                                                         
python work.py --num-epochs 50 --optimiser Adam --lr 0.00001                                                                                                                                                       
python work.py --num-epochs 50 --optimiser AdamW --lr 0.001                                                                                                                                                        
python work.py --num-epochs 50 --optimiser AdamW --lr 0.0001                                                                                                                                                       
python work.py --num-epochs 50 --optimiser AdamW --lr 0.00001                                                                                                                                                      
python work.py --num-epochs 50 --optimiser Adamax --lr 0.001                                                                                                                                                       
python work.py --num-epochs 50 --optimiser Adamax --lr 0.00001                                                                                                                                                     
