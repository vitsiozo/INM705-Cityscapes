...
python train.py "$@" --model EnhancedSwin --granularity fine --no-resize --batch-size 4 --epochs 40 --lr 0.001 --gamma 1 --weight-decay 0.0001
python train.py "$@" --model EnhancedUNet --granularity fine --no-resize --batch-size 4 --epochs 40 --lr 0.001 --gamma 0.31416 --weight-decay 0
python train.py "$@" --model Baseline --granularity fine --no-resize --batch-size 4 --epochs 40
